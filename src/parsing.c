...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/06/12 13:59:18 by meel-war          #+#    #+#             */
/*   Updated: 2025/06/12 14:05:08 by meel-war         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
t_data	*parse_args(int ac, char **av)
{
	...
	if (data->nb_philo == -2 || data->time_to_die == -2 || data->time_to_eat
		== -2 || data->time_to_sleep == -2 || data->nb_must_eat == -2)
	{
